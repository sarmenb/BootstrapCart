...
<div class="authentication-wrapper authentication-2 px-4" style="background-image: url('{{ asset('assets/img/bg/1.jpg') }}');">
    <div class="authentication-inner py-5">
      ...
      <form class="card" method="POST" action="{{ route('password.update') }}">
        ...
        <input type="hidden" name="token" value="{{ route('verification.send') }}">
        <div class="p-4 p-sm-5">
          ...
          @if (session('status') == 'verification-link-sent')
            <div class="mb-4 text-center font-weight-normal">
