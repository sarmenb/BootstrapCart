...
<script type="text/javascript">
    ...
    {
        $("#shipping_billing_checkbox").click(function() {
            $("#shipping_billing_toggle").toggle();
        });
    });
</script>
@endsection
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="process-steps margin-50px-bottom sm-margin-35px-bottom">
                            <a class="step active" href="{{ route('guest.checkout.address') }}">
                            ...
                            <div class="inner-title">
                                ...
                                <div class="row">
                                    <div class="col-sm-12 mb-2">
                                            <input type="checkbox" name="billing_shipping" id="shipping_billing_checkbox" value="1">
                                            <label>
                                ...
                                <div id="shipping_billing_toggle">
                                ...
                                <div class="buttons-set">
                                    <a href="{{ route('guest.cart') }}" class="butn-style2 wide"><i class="fas fa-arrow-left margin-5px-right"></i> Back</a>
