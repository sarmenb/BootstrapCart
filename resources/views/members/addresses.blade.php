                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="common-block">
                            ...
                            <div class="inner-title">
                                <h4 class="no-margin-bottom">Contact Address</h4>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-12 mb-2">
                                        <div class="custom-control custom-checkbox">
                                            ...
                                            <label class="custom-control-label" for="terms-condition">Same as contact address</label>
                                        </div>
                                    </div>

                                </div>

                                <button type="button" class="butn-style2 margin-20px-top">Update Address</button>
